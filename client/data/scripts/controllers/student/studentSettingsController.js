(function()
{
    ...
    app.controller("studentSettingsController", function($route, navbarService, userService, passwordService)
    {
        ...
        {
            var oldpass1 = document.getElementById("stud-old-pass-1");
            var oldpass2 = document.getElementById("stud-old-pass-2");
            var newpass = document.getElementById("stud-new-pass");
